...
kpss_ITS_weekly_vitamin <- sapply(unique(df_analysis_ITS_weekly_vitamin$new_label), function(x) {
  nn <- x
  ...
  kpss_level_df <- tibble::tibble(item = "nutrient - vitamin"
                                  , group = nn
  ...
  kpss_trend_df <- tibble::tibble(item = "nutrient - vitamin"
                                  , group = nn
