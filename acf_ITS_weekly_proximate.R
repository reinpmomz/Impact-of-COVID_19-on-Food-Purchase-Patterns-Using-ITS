...
grDevices::png(filename = base::file.path(output_Dir, paste0("acf_ITS_weekly_proximate_plot", ".png")),
               height = 7,
               width = 10,
               units = "in",
               res = 300,
...
acf_ITS_weekly_proximate <- sapply(unique(df_analysis_ITS_weekly_proximate$new_label), function(x) {
  nn <- x
